...
- Suggested launcher: `code-agentzero`
...
### andclaw-comms
- Slug: `andclaw_comms`
- Path: `/mnt/storage/Cole/Projects/andclaw-comms`
- Category: `unknown`
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-andclaw_comms`
...
### archive
- Slug: `archive`
- Path: `/mnt/storage/Cole/Projects/archive`
- Category: `archive`
- Status: `review`
- Recommended action: `ignore`
- Suggested launcher: `code-archive`
...
- Slug: `casebot_public_record_checks`
- Path: `/mnt/storage/Cole/Projects/casebot_public_record_checks`
- Category: `unknown`
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-casebot_public_record_checks`
...
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-dj_request_system`
...
### endgame-solutions
- Slug: `endgame_solutions`
- Path: `/mnt/storage/Cole/Projects/endgame-solutions`
- Category: `unknown`
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-endgame_solutions`
...
- Status: `review`
- Recommended action: `register_full`
- Suggested launcher: `code-extension_blip`
...
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-homeassistant`
...
### Maltego
- Slug: `maltego`
- Path: `/mnt/storage/Cole/Projects/Maltego`
- Category: `unknown`
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-maltego`
...
- Status: `review`
- Recommended action: `register_full`
- Suggested launcher: `code-media_dedupe`
...
### NOTEvil-Inc
- Slug: `notevil_inc`
- Path: `/mnt/storage/Cole/Projects/NOTEvil-Inc`
- Category: `unknown`
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-notevil_inc`
...
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-primal`
...
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-primal_web_app`
...
- Status: `review`
- Recommended action: `register_full`
- Suggested launcher: `code-project_forge_registry`
...
### recon_housekeeping
- Slug: `recon_housekeeping`
- Path: `/mnt/storage/Cole/Projects/recon_housekeeping`
- Category: `active_project`
- Status: `review`
- Recommended action: `register_full`
- Suggested launcher: `code-recon_housekeeping`
...
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-sillytavern`
...
- Slug: `spiderfoot_peoplesearch`
- Path: `/mnt/storage/Cole/Projects/SpiderFoot_PeopleSearch`
- Category: `active_project`
- Status: `review`
- Recommended action: `register_full`
- Suggested launcher: `code-spiderfoot_peoplesearch`
...
### SteelSeries_RGB
- Slug: `steelseries_rgb`
- Path: `/mnt/storage/Cole/Projects/SteelSeries_RGB`
- Category: `active_project`
- Status: `review`
- Recommended action: `register_full`
- Suggested launcher: `code-steelseries_rgb`
...
### Stormchaser407
- Slug: `stormchaser407`
- Path: `/mnt/storage/Cole/Projects/Stormchaser407`
- Category: `unknown`
- Status: `review`
- Recommended action: `review_required`
- Suggested launcher: `code-stormchaser407`
