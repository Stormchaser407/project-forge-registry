...
- Project Forge owns technical discovery, classification, readiness, and guarded technical operator workflows.
...
- Start by reading `PROJECT_CHARTER.md`, existing docs, and generated artifacts.
